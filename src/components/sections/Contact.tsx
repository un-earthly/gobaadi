...
export function Contact() {
  return (
    <section id="contact" aria-labelledby="contact-heading" className="relative bg-brand-primary py-16 md:py-24 ">
      {/* Wave separator */}

      <img src="./images/footer-top.png" className="absolute -top-10 h-full w-full" alt="" />
      ...
      <div className="absolute inset-0 pointer-events-none hidden lg:block" aria-hidden>
        <div className="absolute left-1/2 top-1/2 h-225 w-225 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/15 blur-[160px]" />
        <div className="absolute left-1/2 top-1/2 h-55 w-55 -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-primary opacity-70 blur-[45px]" />
      </div>

      {/* Grid overlay */}
      <div className="absolute inset-0 z-1 mx-auto my-auto hidden max-w-350 rounded-full opacity-50 lg:block" style={{
        height: "700px",
      ...
      <Container size="wide" className="relative z-10">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between items-end">
            ...
            {/* Social links */}
            <div className="mb-6 flex flex-col items-end gap-3 px-1">
                ...
                {socialLinks.map((link) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex h-12 w-12 items-center justify-center rounded-full border border-white/30 bg-white/15 text-white backdrop-blur-md transition-all hover:scale-105 hover:bg-white hover:text-[#1877F2] hover:shadow-md"
                    >
          ...
          <div className="flex items-center justify-center">
            <div className="flex flex-col w-full gap-10">
              <AnimatedSection delay={0.2} className="w-full flex-1">
                <div className="grid grid-cols-1 gap-8 pt-8 md:grid-cols-2 md:gap-10 w-full">
            ...
            <div className="flex w-full flex-col items-stretch lg:col-span-5 lg:items-end">
              <AnimatedSection delay={0.3} direction="right">
                ...
                {/* Form */}
                <div className="w-[490px] rounded-4xl bg-white p-6 shadow-2xl md:p-8">
